      ...
      <div className="w-full flex items-center justify-between p-6">
        ...
        <div className="w-2/6 bg-white m-auto p-10 rounded-lg">
            ...
            <Button
              ...
              onClick={() => passwordPromptAlert("Civil Engineering", "ce123", () => router.push("/pages/chart/CE"))}
            >
              Civil Engineering
            </Button>
            ...
            <Button
              size="lg"
              className="w-full shadow-lg m-2"
              onClick={() => passwordPromptAlert("Computer Engineering","cpe123", () => router.push("/pages/chart/CPE"))}
            >
            ...
            <Button
              size="lg"
              className="w-full shadow-lg m-2"
              onClick={() => passwordPromptAlert("Electrical Engineering","ee123", () => router.push("/pages/chart/EE"))}
            >
            ...
            <Button
              size="lg"
              className="w-full shadow-lg m-2"
              onClick={() => passwordPromptAlert("Electronics Engineering","ece123", () => router.push("/pages/chart/ECE"))}
            >
            ...
            <Button
              size="lg"
              className="w-full shadow-lg m-2"
              onClick={() => passwordPromptAlert("Industrial Engineering","ie123", () => router.push("/pages/chart/IE"))}
            >
            ...
            <Button
              size="lg"
              className="w-full shadow-lg m-2"
              onClick={() => passwordPromptAlert("Mechanical Engineering","me123", () => router.push("/pages/chart/ME"))}
            >
